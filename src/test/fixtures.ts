...
const recipes: Recipe[] = [
  {
    ...fixtureBase('recipe-teriyaki'),
    name: 'Teriyaki Steak Bowls',
    description: 'Seared steak, vegetables, and teriyaki over rice.',
    ...
    steps: [{ id: 's-ts-1', text: 'Cook, assemble, and serve.' }],
    nutritionPerServing: nutrition(610, 42, 66, 19, 6, 740),
    nutritionProvenance: createUnknownNutritionProvenance(nowIso(), 'Test fixture'),
    sourceLabel: 'Test fixture',
  },
  {
    ...fixtureBase('recipe-burrito'),
    name: 'Chicken Burrito Bowls',
    description: 'Chicken, rice, beans, corn, and avocado.',
    ...
    ingredients: [
      ...
      ingredient('i-cb-4', 'salt', null, '', 'Pantry', 'to taste'),
    ],
    steps: [{ id: 's-cb-1', text: 'Cook and assemble.' }],
    nutritionPerServing: nutrition(560, 44, 65, 14, 12, 610),
    nutritionProvenance: createUnknownNutritionProvenance(nowIso(), 'Test fixture'),
    sourceLabel: 'Test fixture',
  },
  {
    ...fixtureBase('recipe-oats'),
    ...
    steps: [{ id: 's-oo-1', text: 'Mix and chill.' }],
    nutritionPerServing: nutrition(420, 29, 57, 9, 9, 180),
    nutritionProvenance: createUnknownNutritionProvenance(nowIso(), 'Test fixture'),
    sourceLabel: 'Test fixture',
  },
  {
    ...fixtureBase('recipe-pasta'),
    ...
    prepMinutes: 10,
    cookMinutes: 20,
    ingredients: [ingredient('i-wp-1', 'rigatoni', 1, 'lb', 'Pantry')],
    steps: [{ id: 's-wp-1', text: 'Boil and toss.' }],
    nutritionPerServing: nutrition(510, 19, 82, 11, 7, 590),
    nutritionProvenance: createUnknownNutritionProvenance(nowIso(), 'Test fixture'),
    sourceLabel: 'Test fixture',
  },
  {
    ...fixtureBase('recipe-sandwich'),
    name: 'Breakfast Sandwich',
    description: 'Egg and cheese on a muffin.',
    ...
    prepMinutes: 5,
    cookMinutes: 10,
    ingredients: [ingredient('i-bs-1', 'English muffin', 1, 'each', 'Bakery')],
    steps: [{ id: 's-bs-1', text: 'Cook and assemble.' }],
    ...
    meals: [
      {
        ...
        preparedServings: 2,
        consumedServings: 1,
        sourceSnapshot: recipeSnapshot(oats),
      },
      {
        ...
        preparedServings: 4,
        consumedServings: 0,
        sourceSnapshot: recipeSnapshot(burrito),
      },
    ],
    foodLog: [
      {
        ...fixtureBase('log-oats'),
        date: todayDate,
        name: oats.name,
        servings: 1,
        nutritionSnapshot: { ...oats.nutritionPerServing },
        provenanceSnapshot: { ...oats.nutritionProvenance },
        sourceSnapshot: recipeSnapshot(oats),
        origin: 'recipe',
      },
    ],
